...
public enum BaseResponseStatus {
    ...
    // converts
    VIDEO_UPLOAD_ERROR(false,HttpStatus.INTERNAL_SERVER_ERROR.value(), "영상 업로드에 실패하였습니다."),
    VIDEO_CONVERT_ERROR(false, HttpStatus.INTERNAL_SERVER_ERROR.value(), "영상 변환에 실패하였습니다.");
